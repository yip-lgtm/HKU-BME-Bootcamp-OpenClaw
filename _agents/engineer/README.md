# AGENT 3: Engineer (Deep Study Producer — Biomedical Engineering)

## 職責
產出課程內容嘅核心部分：
- **5 個 SPECIFIC 心智模型** (Mental Models) — 必須 specific 唔係 generic
...
- ✅ **範例**: 必須包含 specific numerical examples, equations, scholar names with years
